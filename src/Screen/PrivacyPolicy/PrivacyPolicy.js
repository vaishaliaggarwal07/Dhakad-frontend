        ...
        <div className="main-content">
            <div className="container">
                ...
                <div className={classes.level1Text}>
                    Privacy Policy describes how and when Dhaakad Cinema collects, processes, uses and shares your
                    information when you use Dhaakad Cinema, including our mobile applications and websites
                    (the "Services"). Dhaakad Cinema receives your information through our mobile applications,
                    websites, email notifications, and other interactions with our Services. By accessing and/or using
                    the Services, you consent and authorize us to the collection, transfer, processing, storage,
                    disclosure and other uses of your information as described in this Privacy Policy. If you do
                    not agree with any or all of the following terms of the Privacy Policy, please Do Not Use and/or
                    access the Services
                </div>
                ...
                <div className={classes.level2Text}>Services include several features to help connect you to the
                    accounts of people you already know. For example, you may upload information from your address book
                ...
                <div className={classes.level2Text}>Dhaakad Cinema is an Over the Top (OTT) digital on demand Service
                    ...
                    information is broadly and instantly disseminated. For instance, your profile information and public
                    content are immediately delivered to a wide range of users and other services that access Dhaakad
                ...
                <div className={classes.level2Text}>We do not collect the "Personal Information" which can identify you
                    ...
                    interact with our apps. Non-personal identification information may include the type of your phone,
                ...
                <div className={classes.level1Text}>
                    ...
                    example, companies we've hired to provide data analytical services may need collect and access to
                ...
                <div className={classes.level2Text}>If Dhaakad Cinema needs to host/ store its data which includes the
                    Users data as available with Dhaakad Cinema to severs falling out of Users jurisdiction, Dhaakad
                    Cinema will take all reasonable efforts to ensure that transfer and storage of such data to servers
                    located outside the Users jurisdiction are bound by duty of confidentiality
                </div>
