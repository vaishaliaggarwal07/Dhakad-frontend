...
const MyMovie = (props) => {
  ...
  // like more movie
  const moreMovieData = useSelector(
  ...
  const moreMovieDetails = moreMovieData?.data?.movies
    ? moreMovieData?.data?.movies
    : "";
                  ...
                  <div className="movie-detail movie-content-section">
                    ...
                    <span className="movie-time">
                      {`${movieDetails?.duration} • ${
                        movieDetails?.categories
                          ? movieDetails?.categories?.slice(0, 2)?.join(",")
                          : ""
                    ...
                    <div className="movie-icon-button">
                      {isAuthenticated ? (
                        <Rent
                          modalBtn={
                            <NavLink to={`/payment-option/${movieDetails?.id}`}>
                              <UniqueBtn
